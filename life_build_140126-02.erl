-module(life).
-export([comm/1, comm/2, loop/0, rpc/2, saveArray/3, saveRandomArray/2, read/1, genRandomArray/1, start/0]).
...
start() ->
	{_Size, List} = read("mala"), %tymczasowo wczytuje z pliku,
...
loop() ->
    ...
    {From, {licz, Param, Tablica}} ->
        ...
        WithZeros= addZeros(NowaTablica, Param),
